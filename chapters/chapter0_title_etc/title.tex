\begin{titlepage}
  ...
  \begin{center}
    ...
    {\fontsize{20.26pt}{1em}\selectfont Έρευνα σε Mεθόδους Μηχανικής Μάθησης με χρήση CNN για Aναγνώριση και Eντοπισμό Aντικειμένων \& Yλοποίηση στο Eνσωματωμένο Σύστημα Jetson-TK1}
