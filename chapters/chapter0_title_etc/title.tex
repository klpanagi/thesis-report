\begin{titlepage}
  ...
  \begin{center}
    ...
    {\fontsize{20.26pt}{1em}\selectfont Έρευνα σε μεθόδους Μηχανικής Μάθησης με χρήση DNN για αναγνώριση και εντοπισμό αντικειμένων και υλοποίηση στο ενσωματωμένο σύστημα Jetson-TK1}
