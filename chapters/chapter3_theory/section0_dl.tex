...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{./images/chapter3/autoencoder.png}
  \caption[Autoncoder]{Autoncoder}
  \label{fig:autoencoder}
\end{figure}

Ένα καλό παράδειγμα αλγόριθμου εκμάθησης αναπαραστάσεων είναι αυτό του Autoencoder \autoref{fig:autoencoder}.
