...
Οι αλγόριθμοι ML, επιτρέπου σε συστήματα AI
να προσαρμόζονται εύκολα σε καινούργια έργα, με ελάχιστη επέμβαση από τον άνθρωπο.
Για παράδειγμα, ένα Νευρωνικό Δίκτυο που έχει εκπεδευτεί να αναγνωρίζει γάτες σε εικόνες,
...
\begin{minipage}{0.5\textwidth}  %% Minipage
  ...
  "τιμωρούν" μοντέλα, βασισμένα στην πολυπολοκότητα τους, ευνοώντας έτσι
